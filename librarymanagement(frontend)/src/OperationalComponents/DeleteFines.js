...
const DeleteFines = () => {
    ...
    async function handleSubmit(event) {
        ...
        try{
            await axios.delete(`http://localhost:9001/api/v5/delete/${fine_id}`,JSON.stringify(post),  
    ...
    return (
        ...
        {isLoggedIn ? (
            ...
            <h2 className='link-btn'>Delete Fine</h2><hr/>
            <form className="register-form">
           
           <label htmlFor="Enter Fine ID">Fine ID</label>
            <input onChange={handleInput} type="number" placeholder="Fine Id" id="fine_id" name="fine_id" />
            <button onClick={handleSubmit}>Delete Fine</button><hr/>
